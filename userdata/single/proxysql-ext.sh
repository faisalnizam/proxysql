...
admin_variables =
{
        admin_credentials="admin:ALD41Akip3232;cluster1:@T!@#$%;master:logincluster"
        mysql_ifaces="proxy-uat-mysql.eyewa.internal:6032"
...
mysql_servers =
(
 { address="uat.cluster-cbl7sgy4vaxv.ap-southeast-1.rds.amazonaws.com" , port=3306 , hostgroup=1, max_connections=100 }, // DB URL Write
 { address="uat.cluster-ro-cbl7sgy4vaxv.ap-southeast-1.rds.amazonaws.com" , port=3306 , hostgroup=2, max_connections=100 }, // DB URL Reader
)
